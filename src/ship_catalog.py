...
TAU_CATALOG: List[ShipClassEntry] = [
    ...
    ShipClassEntry(
        ...
        weapons=[
            ...
            {"name": "Prow Gravitic Launcher",     "weapon_type": "gravitic_launcher","range_cm": 40,"strength": 8, "arcs": ["front"], "torpedo_speed": 40, "torpedo_type": "guided"},
        ],
    ...
    ShipClassEntry(
        ...
        weapons=[
            ...
            {"name": "Prow Gravitic Launcher",     "weapon_type": "gravitic_launcher","range_cm": 40,"strength": 6, "arcs": ["front"], "torpedo_speed": 40, "torpedo_type": "guided"},
        ],
        special_rules=["deflector"],
        upgrades_available=_TAU_UPGRADES_CRUISER,
    ),
    ...
    ShipClassEntry(
        ...
        weapons=[
            ...
            {"name": "Prow Gravitic Launcher",     "weapon_type": "gravitic_launcher","range_cm": 40,"strength": 3, "arcs": ["front"], "torpedo_speed": 40, "torpedo_type": "guided"},
        ],
        special_rules=["deflector"],
        upgrades_available=_TAU_UPGRADES_CRUISER,
    ),
    ...
    ShipClassEntry(
        ...
        weapons=[
            ...
            {"name": "Gravitic Launcher",          "weapon_type": "gravitic_launcher","range_cm": 40,"strength": 2, "arcs": ["front"], "torpedo_speed": 40, "torpedo_type": "guided"},
        ],
        special_rules=[],
        upgrades_available=_TAU_UPGRADES_ESCORT,
    ),
