...
async function _fetchPyModules() {
    ...
    const srcFiles = [
        ...
        "py/src/end_phase.py",
        "py/src/scenario.py",
        "py/src/victory_points.py",
        "py/src/squadron.py",
        "py/src/terrain_effects.py",
        "py/src/deployment.py",
        "py/src/turn_controller.py",
        "py/src/ai_player.py",
        "py/src/lookahead_ai.py",
        "py/src/ship_catalog.py",
